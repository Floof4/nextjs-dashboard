        ...
        <div id="footer-body">
            <div className="footer-inner">
                <div className="footer-grid">
                    <div>
                        <Image src="https://res.cloudinary.com/dvn2qowpg/image/upload/v1777399428/LWS/Logo/Wordmark_Red_pjjmyc.png" alt="Lightweight Solutions" width={150} height={50} style={{ height: '22px', marginBottom: '12px' }} />
                            ...
                            <div className="footer-socials">
                                ...
                                <Link href="https://twitter.com/LW_Solutions" target="_blank" className="f-social" aria-label="X">
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2" /></svg>
                                </Link>
                            </div>
